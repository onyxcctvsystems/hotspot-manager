#!/bin/bash
# 🔧 GRADLE WRAPPER FIX: Rebuild the Gradle wrapper and build APK

echo "🔧 Gradle Wrapper Fix..."
echo "============================================="

# Navigate to project directory
cd ~/hotspot-manager/Hotspot\ Mobile\ APP/android

# Check current gradle wrapper status
echo "🔍 Checking current Gradle wrapper..."
ls -la gradle/wrapper/
ls -la gradlew

# Download and fix the Gradle wrapper
echo "📥 Downloading new Gradle wrapper..."
